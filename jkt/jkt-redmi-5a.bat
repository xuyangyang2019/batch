...
adb -s %1 push D:\\JKT\\RedMi_5A\\xposed-v89-sdk25-arm64-miui9.zip /sdcard
...
fastboot -s %1 flash recovery D:\\JKT\\RedMi_5A\\recovery_5.img 
fastboot -s %1  boot D:\\JKT\\RedMi_5A\\recovery_5.img