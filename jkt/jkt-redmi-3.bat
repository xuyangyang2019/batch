...
adb -s %1 push D:\\JKT\\RedMi_3\\xposed-v87-sdk22-arm64-MIUI.zip /sdcard
...
fastboot -s %1 flash recovery D:\\JKT\\RedMi_3\\redmi3.img 
fastboot -s %1  boot D:\\JKT\\RedMi_3\\redmi3.img