...
adb -s %1 push D:\\JKT\\Mi_Max2\\xposed-v88.2-sdk25_forAndroid7.1x-arm64-test4.zip /sdcard
...
fastboot -s %1 flash recovery D:\\JKT\\Mi_Max2\\max2.img 
fastboot -s %1  boot D:\\JKT\\Mi_Max2\\max2.img 