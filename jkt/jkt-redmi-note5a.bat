...
REM fastboot -s %1 flash recovery D:\\JKT\\RedMI_Note5A\\recovery_note5a.img 
REM fastboot -s %1  boot D:\\JKT\\RedMI_Note5A\\recovery_note5a.img
fastboot -s %1 flash recovery D:\\JKT\\RedMI_Note5A\\redmi-note-5a-twrp3.1.1-7to-recovery.img 
fastboot -s %1  boot D:\\JKT\\RedMI_Note5A\\redmi-note-5a-twrp3.1.1-7to-recovery.img